...
int main(){
    ...
    VBO vertexBuffer(vertices, 4 * 3 * sizeof(float)); // The VBO store the vertex data to be sent to the GPU
    ...
    EBO indexBuffer(indices, sizeof(indices)); // The IBO stores the indices to be sent to the GPU
